...
const CuartoSeparador = ({ children, procesoEntidad, nombreEmpresa1, objetoConvocatoriaEntidad,
...
.marcoRectangular1{
   margin-top: 40px;
    ...
    border-radius: 20px;
     ...
     box-shadow:inset 0px 5px 380px 380px rgba(255, 255,255, 0.5);
...
export default CuartoSeparador